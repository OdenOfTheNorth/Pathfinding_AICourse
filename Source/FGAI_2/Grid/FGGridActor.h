...
public:
	...
	*/
	...
	UPROPERTY()
	UFGLineBatchComponent* FGLineBatch = nullptr;
	...
	*/
	...
	void GetNeighborsFromWorldPosition(FVector currentPos, TArray<FFGTileinfo> Neighbors);
